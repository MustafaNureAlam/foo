        ...
        <ul class="nav" id="side-menu">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            <li>
                                <a href="individual_assessment-generate_report-individual.php">Individual</a>
                            </li>
                            <li>
                                <a href="#">Batch-wise</a>
                            </li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        ...
                        <ul class="nav nav-third-level">
                            ...
                            <li>
                                <a href="ell_data-analytics-Who_i_know.php">Who I Know</a>
                            </li>
                            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="#">
                            <i class="fa-fw"></i> Enter Traning Data <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-third-level">
                            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="advance_traning-analytics.php">Analytics</a>
                    </li>
                </ul>
            </li>
            <!-- #### -->
            ...
            <li>
                <a href="business_plan_trial.php">
                    <i class="fa fa-gavel fa-fw"></i> Business Plan Trial 
                </a>
            </li>
            <!-- #### -->
